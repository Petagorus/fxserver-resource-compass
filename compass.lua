local compass = { cardinal={}, intercardinal={}, needle={}}
...
Citizen.CreateThread( function()
	...
	while compass.show do
		...
		if compass.needle.show then
			drawText( tostring( round( playerHeadingDegrees ) ), compass.position.x + compass.width / 2, compass.position.y - compass.needle.textOffset, {
				size = compass.needle.textSize,
				colour = compass.needle.textColour,
				outline = true,
				centered = true
			})
			DrawRect( compass.position.x + compass.width / 2, compass.position.y, compass.needle.needleSize.w, compass.needle.needleSize.h, compass.needle.needleColour.r, compass.needle.needleColour.g, compass.needle.needleColour.b, compass.needle.needleColour.a )
		end
